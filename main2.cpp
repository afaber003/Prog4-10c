...
void encrypt(string inputFile, string outputFile){
  ...
  else
  {
    ...
    while (inFS >> currToken)
    {
      ...
      // the two boys went to the store.
...
void encrypt(string inputFile, string outputFile){
    ...
    // word, frequency, code
    // end result: vector of the words and their frequencies
    // assign their own code values
    // ex: the: 4 occurences, and: 2 occurences, hi: 1 ouccurence
    // the: code value 1, and: code value 2, hi: code value 3
    // vector: code
